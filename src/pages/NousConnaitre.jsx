...
const NousConnaitre = () => {
  ...
  useEffect(() => {
    ...
    const animatedElements = document.querySelectorAll('.timeline-item, .value-card, .stat-item, .mission-card, .value-item, .animate-on-scroll');
  ...
  // Données de la timeline (de Histoire.jsx)
  const timelineData = [
    {
      year: '1970',
  ...
  return (
    <div className="nos-engagements-page">
      ...
      {/* Introduction Section (de Histoire.jsx) */}
      ...
      {/* Timeline Section (de Histoire.jsx) */}
      ...
      {/* Values Section (de Histoire.jsx) */}
      ...
      {/* Heritage Section (de Histoire.jsx) */}
      ...
      {/* Vision Section (de VisionValeurs.jsx) */}
      ...
      {/* Mission Section (de VisionValeurs.jsx) */}
      ...
      {/* Core Values Section (de VisionValeurs.jsx) */}
