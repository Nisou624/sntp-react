    ...
    const handleScroll = () => {
      ...
      if (newActiveCategory !== activeCategory) {
        ...
        if (leftCategoryElement) {
          ...
          leftScroll.scrollTo({ top: leftScrollTop, behavior: 'smooth' });
        }
      }
    };
            ...
            >
              ...
              <div className="category-overlay">
                ...
                <div className="category-text-overlay">
                  <p className="category-kicker-overlay">
                ...
                <div className="category-project-count">
                  ...
                  {category.projects.length > 1 ? 'Projets' : 'Projet'}
                </div>
              </div>
            </div>
          ))}
          ...
          >
            ...
            <div className="project-content-box">
              <div className="project-header-info">
                <h3 className="project-title-immersive">{project.titre}</h3>
                <p className="project-location-immersive">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="location-icon">
              ...
              <div className="project-meta-footer">
                <span className="project-year-badge">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="calendar-icon">
